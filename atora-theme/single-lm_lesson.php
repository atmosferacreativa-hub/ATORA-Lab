<?php
/**
 * Lesson single fallback forwarder.
 *
...
if ( defined( 'ATORA_LMS_DIR' ) ) {
	$template = trailingslashit( ATORA_LMS_DIR ) . 'templates/single-lesson.php';
...
while ( have_posts() ) :
	...
	<section class="meridian-page-hero">
		<div class="meridian-page-hero__copy">
			<p class="meridian-eyebrow"><?php esc_html_e( 'Lesson', 'atora-learning' ); ?></p>
			<h1><?php the_title(); ?></h1>
