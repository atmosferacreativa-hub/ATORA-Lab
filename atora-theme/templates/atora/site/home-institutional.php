...
?>
<article class="atora-template atora-template-site atora-template-home-institutional">
    ...
    <?php atora_theme_render_registered_sections('home-institutional', $context); ?>
</article>
