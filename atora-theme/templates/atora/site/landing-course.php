...
?>
<article class="atora-template atora-template-site atora-template-landing-course atora-landing-shell atora-landing-course">
    ...
    <?php atora_theme_render_registered_sections('landing-course', $context); ?>
</article>
