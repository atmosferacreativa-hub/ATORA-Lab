...
?>
<article class="atora-template atora-template-site atora-template-page-institutional">
    ...
    <?php atora_theme_render_registered_sections('page-institutional', $context); ?>
</article>
