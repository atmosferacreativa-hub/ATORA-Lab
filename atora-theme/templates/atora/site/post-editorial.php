...
?>
<article class="atora-template atora-template-site atora-template-post-editorial atora-post-editorial">
    ...
    <?php atora_theme_render_registered_sections('post-editorial', $context); ?>
</article>
