<?php
/**
 * Program single fallback forwarder.
 *
...
if ( defined( 'ATORA_LMS_DIR' ) ) {
	// template_include in ATORA_v5 should normally resolve the correct program template
	// before WordPress falls back to this theme file. Keep this file as a minimal safety net.
	$plugin_template = trailingslashit( ATORA_LMS_DIR ) . 'templates/single-program.php';
...
while ( have_posts() ) :
	...
	<section class="meridian-page-hero">
		<div class="meridian-page-hero__copy">
			<p class="meridian-eyebrow"><?php esc_html_e( 'Program', 'atora-learning' ); ?></p>
			<h1><?php the_title(); ?></h1>
